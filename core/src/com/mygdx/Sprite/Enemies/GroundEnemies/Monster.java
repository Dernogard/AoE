 ...
 */
public class Monster extends AllEnemies {
    public Monster(AllLevels lvl, Rectangle bounds) {
        super(lvl, bounds);

        skinMonster = new TextureRegion(lvl.getAtlas().findRegion("Enemies"), 128, 0, 128, 128);
    ...
    private void defineHitZone () {
        ...
        coords[2] = new Vector2(-60,55).scl(1 / MyGdxGame.PPM);
        coords[3] = new Vector2(50,55).scl(1 / MyGdxGame.PPM);
