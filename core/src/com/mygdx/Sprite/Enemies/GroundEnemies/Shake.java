 ...
 */
public class Shake extends AllEnemies {
    public Shake(AllLevels lvl, Rectangle bounds) {
        super(lvl, bounds);

        skinMonster = new TextureRegion(lvl.getAtlas().findRegion("Enemies"), 384, 0, 128, 128);
    ...
    private void defineHitZone () {
        ...
        coords[2] = new Vector2(-40,90).scl(1 / MyGdxGame.PPM);
        coords[3] = new Vector2(20,90).scl(1 / MyGdxGame.PPM);
